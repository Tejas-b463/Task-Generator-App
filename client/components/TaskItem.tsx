    ...
    <div className="flex items-center justify-between bg-white border border-slate-200 rounded-lg p-4 hover:border-slate-300 transition-colors group">
      ...
      <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <Button
          ...
          variant="ghost"
          size="sm"
          className="h-9 px-3 cursor-pointer text-blue-600 hover:text-blue-700 hover:bg-blue-50"
        >
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="h-9 px-3 cursor-pointer text-red-600 hover:text-red-700 hover:bg-red-50"
        >
